...
public class cetak_penjualan extends javax.swing.JFrame {
    ...
    /**
     * Creates new form cetak_penjualan
     */
    public cetak_penjualan() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Cetak Laporan Penjualan");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cetak_penjualan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cetak_penjualan().setVisible(true);
            }
        });
    }
